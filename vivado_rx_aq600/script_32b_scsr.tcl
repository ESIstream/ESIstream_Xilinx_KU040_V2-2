...
add_files $path_src_rx_ip/rx_output_buffer_wrapper_scsr.vhd
...
# Add xdc source file
add_files -fileset constrs_1 $path_xdc/rx_esistream_top_32b_scsr.xdc
